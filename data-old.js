...
// Focus: DSA + System Design + AI Engineering (LLMs, RAG, Agents, Evals) + Vibe Coding
// Each week has 7 days, each day has tasks with: text, tag (for color)

const PLAN_DATA = [
  // ===== WEEK 1: Foundation Rebuilding — Arrays & Hashing + LLM Fundamentals =====
  {
    week: 1,
    theme: "Foundation Rebuilding — Arrays, Hashing, LLM Fundamentals",
    days: [
      {
        ...
        tasks: [
          ...
          { text: "AI Setup: Get API keys for OpenAI + Anthropic, install Cursor IDE, test 'Hello World' API call", tag: "ai" },
        ]
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Read 'How LLMs Work' — tokenization, next-token prediction, temperature, context windows (45 min)", tag: "ai" },
          { text: "AI: Send first API calls to OpenAI + Anthropic — explore system prompts, temperature, max_tokens (30 min)", tag: "ai" },
      ...
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Prompt engineering basics — system prompts, few-shot examples, chain-of-thought technique (45 min)", tag: "ai" },
          { text: "AI: Practice structured output — use JSON mode or Instructor library to get reliable structured responses (30 min)", tag: "ai" },
        ]
      },
      {
      ...
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Read about embeddings — word2vec intuition, sentence embeddings, OpenAI embedding API (30 min)", tag: "ai" },
          { text: "AI: Generate embeddings for 10 sentences, compute cosine similarity, understand when vectors are 'close' (30 min)", tag: "ai" },
  ...
  // ===== WEEK 2: Foundation — Two Pointers, Sliding Window, Stack + Prompt Engineering =====
  {
    week: 2,
    theme: "Foundation — Two Pointers, Sliding Window, Stack + Prompt Engineering & RAG Intro",
    days: [
      {
      ...
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Build a simple RAG pipeline — chunk a document, embed chunks, store in ChromaDB, query with cosine similarity (60 min)", tag: "ai" },
      ...
      {
        day: 6, label: "Saturday", title: "Week 2 Day 6 — Sliding Window Hard + Stack + RAG Pipeline",
        tasks: [
          ...
          { text: "AI: Learn about RAG evaluation — retrieval quality metrics (MRR, NDCG), relevance, information density (30 min)", tag: "ai" },
          { text: "AI: Implement hybrid search — combine keyword (BM25) + vector search for better retrieval (60 min)", tag: "ai" },
      ...
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Test your RAG pipeline — add 5 Q&A pairs, measure retrieval recall, iterate on chunking strategy", tag: "ai" },
    ...
    days: [
      ...
      },
      {
        ...
        tasks: [
          ...
          { text: "AI: Async patterns for LLM apps — concurrent API calls, streaming responses, batch processing, queue-based inference (45 min)", tag: "ai" },
        ]
      },
      {
